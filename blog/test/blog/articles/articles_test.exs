defmodule Blog.ArticlesTest do
  ...
  describe "articles" do
    ...
    @valid_attrs %{content: "some content", published: ~D[2010-04-17], title: "some title"}
    @update_attrs %{content: "some updated content", published: ~D[2011-05-18], title: "some updated title"}
    ...
    test "create_article/1 with valid data creates a article" do
      ...
      assert article.published == ~D[2010-04-17]
    ...
    test "update_article/2 with valid data updates the article" do
      ...
      assert article.published == ~D[2011-05-18]
